...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    private val db by lazy(Dispatchers.IO) { VideoDatabase.getInstance(application.applicationContext) }
    private val repository by lazy(Dispatchers.IO) { VideosRepository(db) }
